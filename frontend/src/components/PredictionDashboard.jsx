  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold text-blue-800 mb-2">Diabetes Risk Assessment</h1>
        <p className="text-gray-600 mb-8">Early detection system using federated learning</p>
            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-4">
                ...
                <div className="pt-4 border-t border-gray-200">
                  <h3 className="text-lg font-medium text-gray-800">Symptoms</h3>
            ...
            {prediction ? (
              <>
                ...
                <div className="bg-white rounded-xl shadow-md p-6">
                  <h2 className="text-xl font-semibold text-gray-800 mb-4">Clinical Guidance</h2>
                ...
                <div className="bg-white rounded-xl shadow-md p-6">
                  <h2 className="text-xl font-semibold text-gray-800 mb-4">Key Risk Factors</h2>
              ...
              <div className="bg-white rounded-xl shadow-md p-8 text-center">
                ...
                <h3 className="mt-2 text-lg font-medium text-gray-900">No assessment yet</h3>
                <p className="mt-1 text-sm text-gray-500">Submit patient information to evaluate diabetes risk.</p>
              </div>
            )}
          </div>
        </div>
